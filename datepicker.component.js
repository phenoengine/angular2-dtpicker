...
var DatePicker = /** @class */ (function() {
    function DatePicker() {
        ...
        this.today = new Date();
        this.today.setUTCHours(this.today.getUTCHours() + 1);
        this.defaultSettings = {
            defaultOpen: false,
            bigBanner: true,
            timePicker: false,
            format: 'dd-MMM-yyyy HH:mm',
            cal_days_labels: ['Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб'],
            cal_full_days_lables: ["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"],
            cal_months_labels: ['Январь', 'Февраль', 'Март', 'Апрель',
                'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь',
                'Октрябрь', 'Ноябрь', 'Декабрь'
            ],
            cal_months_labels_short: ['Янв', 'Фев', 'Мар', 'Апр',
                'Май', 'Июнь', 'Июль', 'Авг', 'Сен',
                'Окт', 'Нояб', 'Дек'
            ],
            closeOnSelect: true
        };
    ...
    DatePicker.prototype.incHour = function() {
        if(this.hourValue < 23) this.hourValue += 1;
    };
    DatePicker.prototype.decHour = function() {
        if(this.hourValue > 0)  this.hourValue -= 1;
    };
